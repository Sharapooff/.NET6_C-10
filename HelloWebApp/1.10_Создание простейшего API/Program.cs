...
//јрхитектура REST предполагает применение следующих методов или типов запросов HTTP дл€ взаимодействи€ с сервером,
//где каждый тип запроса отвечает за определенное действие:
// GET (получение данных)
// POST(добавление данных)
// PUT(изменение данных)
// DELETE(удаление данных)
// ѕоскольку в приложении ASP.NET Core мы можем получить и адрес запроса и тип запроса, то реализовать подобную архитектуру не трудно.

//—оздание сервера на ASP.NET Core - реализаци€ методов дл€ работы с объектами Person в Program.cs

//ќпределение клиента - основна€ логика здесь заключена в коде javascript + html
